...
@app.route('/') # define the map of website, here the root
@app.route('/home')
def home():
   return render_template('home.html', posts=posts) #kwargs are passed to the html code
...
@app.route('/britney')
def britney():
   return render_template('gimmemore.html')
